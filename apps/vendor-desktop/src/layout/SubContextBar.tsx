      ...
      <div className="flex h-[42px] items-center gap-2 px-3">
        ...
        {displayModule === "sales" && (
          <>
            ...
            <button className="flex items-center gap-1.5 rounded-xl border border-[#e4e7ec] bg-white px-3 py-1.5 text-[12px] font-medium text-[#374151] shadow-[0_1px_2px_rgba(15,23,42,0.04)] transition hover:border-[#FFD35C] hover:bg-[#FFF7CF]/50 hover:text-[#6b4500]">
