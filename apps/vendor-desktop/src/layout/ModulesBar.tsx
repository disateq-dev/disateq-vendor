...
export function ModulesBar() {
  return (
    <section className="flex h-[52px] items-end gap-1 border-t border-[#f1f4f7] px-3 pb-1">
      <button className="flex h-11 items-center gap-2 rounded-2xl border-b-2 border-transparent px-4 text-[14px] font-semibold text-[#475467] transition hover:border-[rgba(22,163,74,0.18)] hover:text-[#111827]">
        <ShoppingCart size={17} />
        <span>TURNO</span>
      </button>

      <button className="flex h-11 items-center gap-2 rounded-2xl border-b-2 border-[rgba(33,84,216,0.3)] bg-[rgba(33,84,216,0.05)] px-4 text-[14px] font-semibold text-[#2154d8] shadow-[0_2px_8px_rgba(33,84,216,0.06)]">
        <Package size={17} />
        <span>VENTAS</span>
      </button>
