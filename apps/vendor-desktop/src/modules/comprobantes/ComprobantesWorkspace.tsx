...
export function ComprobantesWorkspace() {
  ...
  return (
    <section className="flex h-full w-full gap-3">
      ...
      {/* LEFT — LISTA */}
      <div className="flex flex-1 flex-col overflow-hidden rounded-[28px] border border-[#e4e9f0] bg-[#f8fafd] shadow-[0_4px_18px_rgba(15,23,42,0.04)]">
      ...
      <div className="flex w-[280px] shrink-0 flex-col overflow-hidden rounded-[28px] border border-[#e4e9f0] bg-[#f8fafd] shadow-[0_4px_18px_rgba(15,23,42,0.04)]">
